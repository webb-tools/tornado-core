...
var provider = new ethers_1.ethers.providers.JsonRpcProvider('http://localhost:9933');
...
var common = ethereumjs_common_1["default"].forCustomChain('mainnet', {
    name: 'anon',
    networkId: 42,
    chainId: 42
}, 'istanbul');
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var balance, tx, serializedTx, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    tx = new EthereumTx.Transaction(rawTx, { common: common });
                    tx.sign(privateKey);
                    console.log(tx);
                    serializedTx = tx.serialize();
                    return [4 /*yield*/, provider.sendTransaction('0x' + serializedTx.toString('hex'))];
                case 2:
                    hash = (_a.sent()).hash;
                    console.log(hash);
