...
var privateKey = new Buffer.from('99B3C12287537E38C90A9219D4CB074A89A16E9CDB20BF85728EBD97C343E342', 'hex');

const anonChainParams = { name: 'anon', chainId: 42, hardforks: 'istanbul' };
const common = new Common('mainnet', anonChainParams, 'istanbul');
